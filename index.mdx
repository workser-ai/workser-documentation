...
<Columns cols={2}>
  <Card title="Prebuilt UI" icon="window">
  ...
  <Card title="Software Product" icon="box-check" iconType="regular">
...
Get started with How to docs

<Columns cols={2}>
  <Card title="Integrate into your platform" icon="plug-circle-check" href="/quickstart">
